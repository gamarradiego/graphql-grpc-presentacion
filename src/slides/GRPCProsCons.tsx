    ...
    <Slide backgroundColor="#0b0d1a">
      <FlexBox height="100%" flexDirection="column">
        ...
        <FlexBox width="100%" justifyContent="space-between" alignItems="stretch" style={{ gap: '24px' }}>
          <Box backgroundColor="#0a1a0a" padding="24px" borderRadius="8px" style={{ border: '1px solid #064e3b', flex: 1, minWidth: 0 }}>
          ...
          <Box backgroundColor="#1a0a0a" padding="24px" borderRadius="8px" style={{ border: '1px solid #7f1d1d', flex: 1, minWidth: 0 }}>
