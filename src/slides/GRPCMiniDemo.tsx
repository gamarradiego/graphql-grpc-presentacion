        ...
        <FlexBox width="100%" justifyContent="space-between" alignItems="stretch" gap="16px">
          ...
          <Box width="56%">
            ...
            <FlexBox width="100%" justifyContent="space-between" gap="10px" marginBottom="10px">
              <MiniStep
                title="2. Server Add"
                body="El servicio recibe a y b, ejecuta la suma y responde por RPC."
                color="#34d399"
              />
              <MiniStep
                title="3. Resultado binario"
                body="La respuesta viaja en HTTP/2 como protobuf, no como JSON."
                color="#fbbf24"
              />
            </FlexBox>
                ...
                <FlexBox flexDirection="column" gap="10px">
                  ...
                  <Box backgroundColor="#0d1117" padding="14px 16px" borderRadius="10px" style={{ border: '1px solid #1f2937' }}>
                    ...
                    <Text fontSize="0.8rem" color="#cbd5e1" margin="0">
                      gRPC permite invocar operaciones tipadas como si fueran funciones locales, pero en realidad son RPC remotas.
                    </Text>
                  </Box>
                  ...
                  <Box backgroundColor="#0d1117" padding="14px 16px" borderRadius="10px" style={{ border: '1px solid #1f2937' }}>
                    ...
                    <Text fontSize="0.8rem" color="#cbd5e1" margin="0">
                      Es útil cuando importa el rendimiento y el contrato estricto entre servicios internos.
                    </Text>
                  </Box>
